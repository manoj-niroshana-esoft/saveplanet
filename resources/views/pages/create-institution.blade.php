        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create Institution</h4>
                    <a style="float: right" class="btn btn-primary mb-1"
                        href="{!! route('manage-institution.index') !!}">Back</a>
                </div>
                <div class="card-content">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" method="POST" action="{{ route('manage-institution.store') }}">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-6">
