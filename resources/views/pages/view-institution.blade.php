...
@section('title', 'Manage Institution')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Manage Institution</h4>
                    <a style="float: right" class="btn btn-primary"
                        href="{!! route('manage-institution.create') !!}">New Institution</i></a>
                </div>
                            ...
                            <table class="table zero-configuration">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="{!! route('manage-institution.edit', [$institution['institution_id']]) !!}"><i
                                                    class="feather icon-edit"></i></a>
                                            <form id="destroy-form"
                                                action="{{ route('manage-institution.destroy', $institution['institution_id']) }}"
