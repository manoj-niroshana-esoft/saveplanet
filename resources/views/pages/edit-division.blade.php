                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-horizontal" method="POST"
                                    action="{{ route('manage-division.new-update',['id'=>$division['division_id']]) }}">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control"
                                                            value="{{$division->name}}" required name="division_name"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="custom-select form-control" required
                                                            ...
                                                            @if($institution->institution_id==$division->institution_id)
                                                            <option selected value="{{$institution->institution_id}}">
                                                                {{$institution->name}}
                                                            </option>
                                                            @else
